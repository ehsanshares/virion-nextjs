                    ...
                    <div className="integration-top-wrap">
                      <div className="integration-flex-1 reveal">
                        <div className="integration-item-block">
                          <img alt="LoodB" className="integration-logo" loading="lazy" src="/assets/images/LoodB.png" />
                        </div>
                      ...
                      <p className="integration-details-para reveal">
                        The Virion + LoodB combo also elevates async work. Instead of long update threads or endless back-and-forth, Payline can summarize Slack conversations, highlight unresolved action items, and create digestible progress.
                      </p>
                    </div>
