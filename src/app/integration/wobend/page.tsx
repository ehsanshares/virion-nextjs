                    ...
                    <div className="integration-top-wrap">
                      <div className="integration-flex-1 reveal">
                        <div className="integration-item-block">
                          <img alt="Wobend" className="integration-logo" loading="lazy" src="/assets/images/Vector.svg" />
                        </div>
                      ...
                      <p className="integration-details-para reveal">
                        The Virion + Wobend combo also elevates async work. Instead of long update threads or endless back-and-forth, Payline can summarize Slack conversations, highlight unresolved action items, and create digestible progress.
                      </p>
                    </div>
                    <div className="integration-bottom-wrap">
                      ...
                      <div className="authshield-sticky reveal">
                        <div className="integration-icon-block">
                          <img alt="Wobend" className="integration-icon" loading="lazy" src="/assets/images/Vector.svg" />
                        </div>
                        <div className="authshield-flex">
                          ...
                          <p className="authshield-para">
                            Design and publish responsive websites visually with Wobend
                          </p>
                        </div>
