                    ...
                    <div className="integration-top-wrap">
                      <div className="integration-flex-1 reveal">
                        <div className="integration-item-block">
                          <img alt="Sketik" className="integration-logo" loading="lazy" src="/assets/images/Sketik.png" />
                        </div>
                      ...
                      <p className="integration-details-para reveal">
                        The Virion + Sketik combo also elevates async work. Instead of long update threads or endless back-and-forth, Payline can summarize Slack conversations, highlight unresolved action items, and create digestible progress.
                      </p>
                    </div>
                    <div className="integration-bottom-wrap">
                      ...
                      <div className="authshield-sticky reveal">
                        <div className="integration-icon-block">
                          <img alt="Sketik" className="integration-icon" loading="lazy" src="/assets/images/Sketik.png" />
                        </div>
                        <div className="authshield-flex">
                          ...
                          <p className="authshield-para">
                            Stay connected with your team using Sketik real-time messaging.
                          </p>
                        </div>
